...
QUnit.test(
    "Adding data with inline key - objectstore keyPath",
    function (assert) {
        var done = assert.async();
        assert.expect(2);
...
QUnit.test(
    "Adding data with external key - objectstore keyPath",
    function (assert) {
        var done = assert.async();
        assert.expect(1);
        var data = { test: "test" };
...
QUnit.test(
    "Adding data - objectstore keyPath autoincrement",
    function (assert) {
        var done = assert.async();
        assert.expect(2);
        var data = { test: "test" };
...
QUnit.test(
    "Adding data with existing index key - unique index ",
    function (assert) {
        var done = assert.async();
        assert.expect(3);
